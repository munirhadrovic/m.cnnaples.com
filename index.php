...
<html>
	...
	<body>
        ...
        <div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
            <h1 style="font-weight: normal; font-size: 13px;">Powered By <a href="http://mobilegrows.com/" rel="external" style="text-decoration: none;">MobileGrows</a> | <a href="http://cnnaples.com/" rel="external" style="text-decoration: none;">  Desktop Site</a></h1>
        </div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
              ...
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Photos</a>
                  </div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							...
							<li><a href="#page1" data-transition="pop">Menu</a></li>
							<li><a href="#page1" data-transition="pop">Photos</a></li>
                            <li><a href="#page1" data-transition="pop">About Us</a></li>
                            <li><a href="#page1" data-transition="pop">Reviews</a></li>
							<li><a href="#contactform" data-transition="pop">Contact Us</a></li>
						</ul>
					</section>
                    <p class="pad">This is only a <b>preview</b> version of your Mobile Website.<br><br>
			...
			<div data-role="main" class="ui-content" >
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-contact">
							<ul id="menu-contact">
                                <li><a href="#page2" data-transition="fade">Home</a></li>
                                <li><a href="#page2" data-transition="fade">Menu</a></li>
                                <li><a href="#page2" data-transition="fade">Photos</a></li>
                                <li><a href="#page2" data-transition="fade">About Us</a></li>
                                <li><a href="#page2" data-transition="fade">Reviews</a></li>
                                <li><a href="#page1" data-transition="fade">Contact Us</a></li>
							</ul>
					</section>
					<div>	
